...
import 'package:shift/application/profile/account/account_cubit.dart' as _i31;
...
// initializes the registration of main-scope dependencies inside of GetIt
  _i1.GetIt init({
    ...
    gh.factory<_i19.ForgotPasswordBloc>(
        () => _i19.ForgotPasswordBloc(gh<_i6.IAuthFacade>()));
    ...
    gh.factory<_i25.IntroVideoBloc>(
        () => _i25.IntroVideoBloc(gh<_i8.IAccountRepository>()));
    gh.factory<_i26.ExperienceBloc>(
        () => _i26.ExperienceBloc(gh<_i8.IAccountRepository>()));
    gh.factory<_i27.LegalScreeningBloc>(
        () => _i27.LegalScreeningBloc(gh<_i8.IAccountRepository>()));
    gh.factory<_i28.DocumentBloc>(
        () => _i28.DocumentBloc(gh<_i8.IAccountRepository>()));
    gh.factory<_i28.ProfessionalLicensesBloc>(
        () => _i28.ProfessionalLicensesBloc(gh<_i8.IAccountRepository>()));
    gh.factory<_i28.ImmunizationBloc>(
        () => _i28.ImmunizationBloc(gh<_i8.IAccountRepository>()));
    gh.factory<_i28.ProfessionalLiabilityBloc>(
        () => _i28.ProfessionalLiabilityBloc(gh<_i8.IAccountRepository>()));
    gh.factory<_i28.ResumeBloc>(
        () => _i28.ResumeBloc(gh<_i8.IAccountRepository>()));
    gh.factory<_i28.EquipmentBloc>(
        () => _i28.EquipmentBloc(gh<_i8.IAccountRepository>()));
    gh.factory<_i29.SpecialityExperienceBloc>(
        () => _i29.SpecialityExperienceBloc(gh<_i8.IAccountRepository>()));
    gh.factory<_i30.LocationDetailsBloc>(
        () => _i30.LocationDetailsBloc(gh<_i8.IAccountRepository>()));
    gh.factory<_i31.AccountCubit>(
        () => _i31.AccountCubit(gh<_i8.IAccountRepository>()));
    ...
    gh.factory<_i34.ContractorHomeBloc>(
        () => _i34.ContractorHomeBloc(gh<_i10.IMainFacade>()));
