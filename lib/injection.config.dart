...
import 'package:shift/application/location_details/location_details_bloc.dart'
    as _i27;
import 'package:shift/application/main_tab/home/home_bloc.dart' as _i31;
...
import 'package:shift/application/profile/account/account_cubit.dart' as _i28;
...
// initializes the registration of main-scope dependencies inside of GetIt
  _i1.GetIt init({
    ...
    gh.factory<_i27.LocationDetailsBloc>(
        () => _i27.LocationDetailsBloc(gh<_i8.IAccountRepository>()));
    gh.factory<_i28.AccountCubit>(
        () => _i28.AccountCubit(gh<_i8.IAccountRepository>()));
    gh.factory<_i29.EducationDetailBloc>(() => _i29.EducationDetailBloc(
          gh<_i8.IAccountRepository>(),
          gh<_i6.IAuthFacade>(),
        ));
    gh.factory<_i30.ReferenceBloc>(() => _i30.ReferenceBloc(
          gh<_i8.IAccountRepository>(),
          gh<_i6.IAuthFacade>(),
        ));
    gh.factory<_i31.HomeBloc>(() => _i31.HomeBloc(gh<_i10.IMainFacade>()));
    gh.factory<_i32.AddNewMemberBloc>(
        () => _i32.AddNewMemberBloc(gh<_i10.IMainFacade>()));
    return this;
  }
}
