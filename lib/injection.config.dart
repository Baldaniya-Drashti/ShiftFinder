...
// initializes the registration of main-scope dependencies inside of GetIt
  _i1.GetIt init({
    ...
    gh.factory<_i4.ContractorShiftBloc>(() => _i4.ContractorShiftBloc());
    gh.factory<_i5.SendProposalBloc>(() => _i5.SendProposalBloc());
    ...
    gh.factory<_i19.ViewSingleApplicantsBloc>(
        () => _i19.ViewSingleApplicantsBloc(gh<_i12.IMainFacade>()));
    gh.factory<_i20.PostShiftBloc>(
        () => _i20.PostShiftBloc(gh<_i12.IMainFacade>()));
    gh.factory<_i21.AuthStatusBloc>(
        () => _i21.AuthStatusBloc(gh<_i8.IAuthFacade>()));
    gh.factory<_i22.AddContractorSkillFormBloc>(
        () => _i22.AddContractorSkillFormBloc(gh<_i8.IAuthFacade>()));
    gh.factory<_i23.TermsAndConditionBloc>(
        () => _i23.TermsAndConditionBloc(gh<_i8.IAuthFacade>()));
    gh.factory<_i24.ForgotPasswordBloc>(
        () => _i24.ForgotPasswordBloc(gh<_i8.IAuthFacade>()));
    gh.factory<_i25.LoginFormBloc>(
        () => _i25.LoginFormBloc(gh<_i8.IAuthFacade>()));
    gh.factory<_i26.RegisterFormBloc>(
        () => _i26.RegisterFormBloc(gh<_i8.IAuthFacade>()));
    gh.factory<_i27.DocumentBloc>(
        () => _i27.DocumentBloc(gh<_i10.IAccountRepository>()));
    gh.factory<_i27.ProfessionalLicensesBloc>(
        () => _i27.ProfessionalLicensesBloc(gh<_i10.IAccountRepository>()));
    gh.factory<_i27.ImmunizationBloc>(
        () => _i27.ImmunizationBloc(gh<_i10.IAccountRepository>()));
    gh.factory<_i27.ProfessionalLiabilityBloc>(
        () => _i27.ProfessionalLiabilityBloc(gh<_i10.IAccountRepository>()));
    gh.factory<_i27.ResumeBloc>(
        () => _i27.ResumeBloc(gh<_i10.IAccountRepository>()));
    gh.factory<_i27.EquipmentBloc>(
        () => _i27.EquipmentBloc(gh<_i10.IAccountRepository>()));
    gh.factory<_i28.ExperienceBloc>(
        () => _i28.ExperienceBloc(gh<_i10.IAccountRepository>()));
    gh.factory<_i29.IntroVideoBloc>(
        () => _i29.IntroVideoBloc(gh<_i10.IAccountRepository>()));
    gh.factory<_i30.LegalScreeningBloc>(
        () => _i30.LegalScreeningBloc(gh<_i10.IAccountRepository>()));
    ...
    gh.factory<_i36.ContractorHomeBloc>(
        () => _i36.ContractorHomeBloc(gh<_i12.IMainFacade>()));
    gh.factory<_i37.HomeBloc>(() => _i37.HomeBloc(gh<_i12.IMainFacade>()));
    gh.factory<_i38.AddNewMemberBloc>(
        () => _i38.AddNewMemberBloc(gh<_i12.IMainFacade>()));
    return this;
  }
}
