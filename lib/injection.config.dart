...
import 'package:shift/application/location_details/location_details_bloc.dart'
    as _i31;
import 'package:shift/application/main_tab/home/home_bloc.dart' as _i36;
...
// initializes the registration of main-scope dependencies inside of GetIt
  _i1.GetIt init({
    ...
    gh.factory<_i35.ContractorHomeBloc>(
        () => _i35.ContractorHomeBloc(gh<_i11.IMainFacade>()));
    gh.factory<_i36.HomeBloc>(() => _i36.HomeBloc(gh<_i11.IMainFacade>()));
    gh.factory<_i37.AddNewMemberBloc>(
        () => _i37.AddNewMemberBloc(gh<_i11.IMainFacade>()));
    return this;
  }
}
