        ...
        builder: (context, state) {
          return Scaffold(
            ...
            body: PaginatedListView(
              ...
              refreshController: context.read<TeamsBloc>().refreshController,
              onLoading: () {
                context
                    .read<TeamsBloc>()
                      ...
                      : SingleChildScrollView(
                          child: Column(
                            children: [
                                    ...
                                    onTap: () async {
                                      ...
                                      if (res != null && res == true) {
                                        context.read<TeamsBloc>().add(
                                            TeamsEvent.getTeamList(true, null));
                                      }
                                    },
                                    child: CommonTeamContainer(
                                      teamName:
                                          state.getTeamList[index].name ?? "",
                                      address: state.getTeamList[index].location
                                              ?.location ??
                                          "",
                              ...
                              SizedBox(
                                height: getSize(
                                    isFullScreenDevice(context) ? 0 : 20),
                              ),
                            ],
                          ),
                        ),
