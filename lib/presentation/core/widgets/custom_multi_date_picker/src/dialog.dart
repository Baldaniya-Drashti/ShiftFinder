...
import 'package:shift/presentation/core/widgets/custom_multi_date_picker/calendar_date_picker2_with_action_buttons.dart';
...
Future<List<DateTime?>?> showCalendarDatePicker2Dialog({
  ...
  required Map<DateTime, Color> selectedDateColors,
