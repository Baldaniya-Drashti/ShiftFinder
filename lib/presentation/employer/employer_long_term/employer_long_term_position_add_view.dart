...
class EmployerLongTermPositionAddView extends StatelessWidget {
  const EmployerLongTermPositionAddView({super.key});

  @override
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (context) => getIt<EmployerLongTermAddBloc>()..add(EmployerLongTermAddEvent.getAllDropDownList(-1)),
  ...
  Widget roleDropDown(BuildContext context, EmployerLongTermAddState state) {
      ...
      onChanged: (value) {
        if (value != null) {
          context.read<EmployerLongTermAddBloc>().add(
                EmployerLongTermAddEvent.roleTypeChanged(value),
              );
        }
      },
    );
        ...
        CustomLocationDropdDown(
          ...
          validator: (
            p0,
              ...
              context.read<EmployerLongTermAddBloc>().state.location.value.fold(
                    (f) => f.maybeMap(
