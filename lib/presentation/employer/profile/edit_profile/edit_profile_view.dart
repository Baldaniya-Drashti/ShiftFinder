              ...
              child: ListView(
                ...
                children: [
                              ...
                              child: badges.Badge(
                                ...
                                child: Container(
                                  ...
                                  decoration: BoxDecoration(
                                    ...
                                    // image: state.selectedImage.isNotEmpty ? state.selectedImage.contains('https')
                                    //         ? DecorationImage(
                                    //             image: CachedNetworkImageProvider(state.selectedImage),
                                    //             fit: BoxFit.cover,
                                    //           )
                                    //         : DecorationImage(
                                    //             image: FileImage(
                  ...
                  CustomTextField(
                    ...
                    validator: (_, context) => context.read<EditProfileBloc>().state.firstName.value.fold(
                          (f) => f.maybeMap(
                  ...
                  CustomTextField(
                    ...
                    prefixIcon: CommonCountryCodePicker(
                      initialSelection: user.countryNameCode ?? state.selectedCountryFlag,
                  ...
                  SizedBox(height: getSize(10)),
                  CustomTextField(
                    initialValue: user.companyDescription,
                  ...
                  CommonButton(
                    onPressed: () {
                      context.read<EditProfileBloc>().add(EditProfileEvent.updateProfile());
                    },
                    buttonText: "Update",
                  ),
                ],
