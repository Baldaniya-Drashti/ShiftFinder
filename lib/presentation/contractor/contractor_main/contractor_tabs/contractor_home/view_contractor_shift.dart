...
@RoutePage(name: 'ViewContractorShift')
class ViewContractorShift extends StatelessWidget {
  final int postId;
  final bool isTotalApplicants;

  const ViewContractorShift({super.key, required this.postId, this.isTotalApplicants = false});

  @override
  Widget build(BuildContext context) {
    print("shift id--> $postId");
    return BlocProvider(
      create: (context) => getIt<ViewSingleApplicantsBloc>()..add(ViewSingleApplicantsEvent.getShiftDetailEvent(postId)),
