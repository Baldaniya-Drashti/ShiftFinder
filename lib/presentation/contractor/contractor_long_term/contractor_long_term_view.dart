...
import 'package:shift/presentation/contractor/contractor_full_time_position/tabs/open_position_view.dart';
...
class ContractorLongTermView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: CommonAppBar(onBackPressed: () => context.router.maybePop(), title: "Long Term Positions"),
      body: BlocProvider(
