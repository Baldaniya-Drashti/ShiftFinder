  ...
  /*  Future<bool> checkAndRequestStoragePermissions() async {
    if (Platform.isAndroid) {
      ...
      if (android.version.sdkInt >= 33) {
        ...
        // Android 10+ — NO permission needed to pick files using SAF(Storage Access Framework) file_picker
        return true;
      } else {
      ...
      // If you're picking files using FilePicker, you should not request Permission.photos on iOS.
      return true;
    }
  }
          ...
          return AlertDialog(
            ...
            content: Column(
              ...
              children: [
                BaseText(
                  text: Platform.isIOS
                      ? 'Unable to access Photos. Grant access by going to Settings > ShiftFinder > Files and allow access:'
