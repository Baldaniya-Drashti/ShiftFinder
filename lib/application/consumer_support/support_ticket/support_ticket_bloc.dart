...
class SupportTicketBloc extends Bloc<SupportTicketEvent, SupportTicketState> {
  ...
  SupportTicketBloc(this._repository, this._mainFacade) : super(const SupportTicketState()) {
    on<SupportTicketEvent>((event, emit) async {
      await event.map(
        ...
        onCountrySelected: (value) {
          emit(state.copyWith(selectedCountryCode: value.code, selectedCountryFlag: value.flag));
        },
