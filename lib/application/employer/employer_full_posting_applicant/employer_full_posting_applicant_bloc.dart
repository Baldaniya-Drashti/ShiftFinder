...
@injectable
class EmployerFullPostingApplicantBloc extends Bloc<
    EmployerFullPostingApplicantEvent, EmployerFullPostingApplicantState> {
  ...
  EmployerFullPostingApplicantBloc(this._iMainFacade)
      : super(EmployerFullPostingApplicantState.initial()) {
