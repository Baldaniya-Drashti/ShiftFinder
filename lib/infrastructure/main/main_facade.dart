...
*/
  ...
  @override
  Future<Either<MainFailure, CommonResponse>> dontShowEmployerTeamDialog() async {
    try {
  ...
  Future<Either<MainFailure, CommonResponse>> getContractorDashboardListAPI({required int page, int? filterType}) async {
    try {
      ...
      Map<String, dynamic> mapData = {
        ...
        'page': page,
        'perPage': _perPage,
        "start_date": DateTime(now.year, now.month, now.day, 0, 0, 0).toUtc().millisecondsSinceEpoch / 1000,
        "end_date": DateTime(now.year, now.month, now.day, 23, 59, 59, 999).toUtc().millisecondsSinceEpoch / 1000,
      };
  ...
  @override
  Future<Either<MainFailure, CommonResponse>> chatListApi({required int page}) async {
    try {
      Map<String, dynamic> mapData = {
        'page': page,
        'perPage': 50,
      ...
      if (res != null) {
        ...
        res.data == null;
        res.listData = list.map((e) => ChatUser.fromJson(e as Map<String, dynamic>)).toList();
        return right(res);
      } else {
        return left(const MainFailure.serverError());
      }
  ...
  @override
  Future<Either<MainFailure, Map<String, dynamic>>> getMessage({required int page, required int id}) async {
    try {
      Map<String, dynamic> mapData = {
        'page': page,
        'perPage': 20,
      ...
      if (res != null) {
        final list = res.data as List<dynamic>;
        res.data == null;
        res.listData = list.map((e) => MessageData.fromJson(e as Map<String, dynamic>)).toList();
        return right(
          {
            'listData': res,
            'additionalInfo': '',
  ...
  Future<Either<MainFailure, CommonResponse>> deleteEmployerFilledShift({
    ...
    try {
      Map<String, dynamic> mapData = {if (isCad != null) 'isCad': isCad, 'reason': reason};
  ...
  Future<Either<MainFailure, CommonResponse>> getPreviousPost({
    ...
    try {
      ...
      final res = await apiService.getMethod(ApiConstants.employerPreviousShift, queryParameters: mapData);
  ...
  Future<Either<MainFailure, CommonResponse>> getEmployerShift({
    ...
    try {
      final res = await apiService.getMethod(ApiConstants.employerShift, queryParameters: mapData);
  ...
  @override
  Future<Either<MainFailure, ContractorMyCalendarDTO>> getContractorMyCalendarDetailApi(String id, int? date) async {
    try {
      Map<String, dynamic> mapData = {
        'id': id,
      };
  ...
  Future<Either<MainFailure, CommonResponse>> hiredCancelledContractorList({
    ...
    try {
      final res = await apiService.getMethod("${ApiConstants.getEmployerDeleteShiftUser}/$postId",
          queryParameters: {"page": page, "perPage": _perPage, "short_type": shortType});
  ...
  @override
  Future<Either<MainFailure, CommonResponse>> getContractorRatings({required int page}) async {
    try {
      final response = await apiService.getMethod(
  ...
  @override
  Future<Either<MainFailure, CommonResponse>> addCardAPI({required String paymentMethodId}) async {
    try {
      Map<String, dynamic> mapData = {
  ...
  Future<Either<MainFailure, CommonResponse>> employerSavedTemplate({
    ...
    try {
      Map<String, dynamic> mapData = {
        ...
        "shift_type": shiftType,
        if (sameOrDifferentTime != null) "same_or_different_time": sameOrDifferentTime
      };
      final response = await apiService.getMethod(
  ...
  @override
  Future<Either<MainFailure, CommonResponse>> deleteEmployerSavedTemplate({required int id}) async {
    try {
      final response = await apiService.deleteMethod(
  ...
  @override
  Future<Either<MainFailure, String>> deletePaymentCardAPI({required int id}) async {
    try {
      final res = await apiService.deleteMethod(
  ...
  @override
  Future<Either<MainFailure, PerformanceInsightDTO>> getPerformanceInsightListAPI({required double date}) async {
    try {
      Map<String, dynamic> mapData = {
        "date": date,
      };
...
// print("Response of insightss---> ${data}");
  ...
  Future<Either<MainFailure, HealthcarePostDTO>> getSendProposalDetailApi({
    ...
    try {
      ...
      print("Sending Data->  ${jsonEncode(mapData)}");
      final res = await apiService.getMethod(ApiConstants.getSendProposalDetail, queryParameters: mapData);
      if (res != null) {
        final data = HealthcarePostDTO.fromJson(res.data);
        print("Healthercare Post Response->  ${data}");
        return right(data);
  ...
  Future<Either<MainFailure, ApplicantDto>> getReferrealContractorInfoApi({
    ...
    try {
      final response = await apiService.getMethod(ApiConstants.getUserInfo, queryParameters: {"id": id});
  ...
  Future<Either<MainFailure, MonthlyStatementDTO>> getEmployerMonthlyStatementAPI({
    ...
    try {
      Map<String, dynamic> mapData = {
        'start_date': (startDate != null) ? startDate : DateTime.now().toUtc().millisecondsSinceEpoch / 1000,
        'end_date': (endDate != null) ? endDate : DateTime.now().toUtc().millisecondsSinceEpoch / 1000,
      };
  ...
  Future<Either<MainFailure, CommonResponse>> getEmployerLongTermPosition({required int positionType, required int page}) async {
    try {
      final response = await apiService.getMethod(
        ...
        queryParameters: {"post_type": 1, "positions_type": positionType, "page": page, "perPage": 10},
      );
  ...
  @override
  Future<Either<MainFailure, CommonResponse>> updateLongTermStatus({required int id}) async {
    try {
      final response = await apiService.getMethod(
  ...
  @override
  Future<Either<MainFailure, CommonResponse>> getEmployerLongTermPositionApplicants({required int id, required int page}) async {
    try {
      final response = await apiService.getMethod(
  ...
  @override
  Future<Either<MainFailure, CommonResponse>> getEmployerPositionDetail({required int id, required int postType}) async {
    try {
      final response = await apiService.getMethod(
  ...
  Future<Either<MainFailure, CommonResponse>> contractorWithdrawAmount({
    ...
    try {
      ...
      print("Sending Data-> ${jsonEncode(mapData)}");
      final res = await apiService.postMethod(ApiConstants.contractorWithdrawAmount, mapData);
...
// print("Get Wallet List Response-> $data");
  ...
  Future<Either<MainFailure, CommonResponse>> getWalletListAPI({
    ...
    try {
      ...
      print("Sending Data-> ${jsonEncode(mapData)}");
      final res = await apiService.getMethod(ApiConstants.contractorWallet, queryParameters: mapData);
      if (res != null) {
// var account = res.data as List<dynamic>;
// var data = account.map((e) => ContractorWalletDTO.fromJson(e)).toList();
// print("Get Wallet List Response-> $data");
  ...
  Future<Either<MainFailure, CommonResponse>> contractorDashboardLongPost({
    ...
    try {
      final response = await apiService.getMethod(
        ...
        queryParameters: {"post_type": 1, "page": page, "perPage": 10, "positions_type": positionsType},
      );
  ...
  Future<Either<MainFailure, CommonResponse>> contractorDashboardFullPost({
    ...
    try {
      final response = await apiService.getMethod(
        ApiConstants.contractorDashboardLongFullTermPost,
        queryParameters: {"post_type": 2, "page": page, "perPage": 10, "positions_type": positionsType},
      );
